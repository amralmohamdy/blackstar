...
ok('v6.556/6.559/6.566: source sub is the LATEST-starting cycle covering the switch date, reused for the cap', /const _covering = _srcCycleCands\.filter\(s => \(s\.start \|\| ''\) <= switchDate/.test(src) && /const srcSub = _srcSubCycle;/.test(src));

...
function navigate(route, opts) {
  ...
  // v6.612 — the Danger Zone is PIN-gated: re-lock it whenever we navigate away, so it always
  // re-prompts on the next open.
  if (route !== 'danger') { try { window._dangerUnlocked = false; } catch (_) {} }
